...
#else
#define LZ5HC_DEBUG(fmt, ...) ;//printf(fmt, ##args)
#define LZ5_LOG_PARSER(fmt, ...) ;//printf(fmt, ##args)
#define LZ5_LOG_PRICE(fmt, ...) ;//printf(fmt, ##args)
#define LZ5_LOG_ENCODE(fmt, ...) ;//printf(fmt, ##args)
#endif
